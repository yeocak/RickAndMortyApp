...
class LocationCard extends PureComponent {
    ...
    updateCharacterData = async () => {
        for (characterId in (this.location.residents)) {
            const character = await getByLink(this.location.residents[characterId])
        ...
        return (
            ...
            onPress={this.changeIsOpen}>
                <View style={{flexDirection:'row', flexWrap: 'wrap'}}>
                    ...
                    {this.location.dimension != "unknown" &&
                        <Text style={styles.locationTitleText}>({this.location.dimension})</Text>}
                </View>
